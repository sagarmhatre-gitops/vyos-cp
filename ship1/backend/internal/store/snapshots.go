...
func (s *Store) LatestSnapshot(ctx context.Context, deviceID uuid.UUID) (model.DeviceSnapshot, error) {
	var (
...
func (s *Store) ListSnapshots(ctx context.Context, deviceID uuid.UUID, limit int) ([]model.SnapshotSummary, error) {
